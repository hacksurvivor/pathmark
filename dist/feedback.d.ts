...
export declare function recordMemoryQueryRecall(store: PathmarkStore, config: PathmarkConfig, query: string, results: SearchResult[], tags?: string[], channel?: string): Promise<string | undefined>;
