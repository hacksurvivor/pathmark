...
export async function auditMemory(store, options = {}) {
    ...
    return {
        ...
        precision: {
            status: "unlabeled",
            value: null,
            reason: "Recall activity records which ids were injected, but no user relevance labels exist. Stale, duplicate, missing, and coverage signals are reported without pretending they are precision.",
        },
    };
}
